...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> resetVerificationProcess(HttpSession session, @RequestBody Map<String, String> request) {
    ...
    public ResponseEntity<Map<String, Object>> verification(HttpSession session, @RequestBody Map<String, String> request) {
        String code = request.get("code");
