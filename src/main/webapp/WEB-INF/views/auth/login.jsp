...
<body>
	<div class="container">
		<div class="logo">
			<img src="<%=request.getContextPath()%>/static/img/logo.svg"
				alt="새롬터 로고">
		</div>
		<form action="login_process.jsp" method="post">
			<div class="form-group">
				<label for="username">아이디</label> <input type="text" id="username"
					name="username" required placeholder="아이디를 입력해 주세요">
			</div>
			<div class="form-group">
				<label for="password">비밀번호</label> <input type="password"
					id="password" name="password" required placeholder="비밀번호를 입력해 주세요">
			</div>
		...
		<div class="social-login">
			...
			<a href="<%=request.getContextPath()%>/oauth2/authorization/google">
				<img src="<%=request.getContextPath()%>/static/img/google.png"
				alt="Google 로그인">
			</a> 
			
			<a href="<%=request.getContextPath()%>/oauth2/authorization/kakao">
				<img src="<%=request.getContextPath()%>/static/img/kakao.png"
				alt="Kakao 로그인">
			</a>
