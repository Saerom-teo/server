<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/image_upload.js"></script>
    ...
    <body>
        <h1>올레픽 수거 요청하기</h1>
        <form action="../api/collection/request" method="post" onsubmit="enableAddress()">
